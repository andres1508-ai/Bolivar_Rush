...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function drawModal() {
        ...
        if (appState.modal.type === 'extra_benefits') {
            ...
            // Determinar qué categoría de beneficios mostrar basándose en la categoría actual
            const activeTransportPlans = getActiveTransportPlans();
            const activeTechPlans = getActiveTechnologyPlans();
            
            let benefitsCategory = appState.currentCategory || 'tecnologia'; // Usar la categoría actual
            let categoryLabel = benefitsCategory === 'transporte' ? 'Transporte' : 'Tecnología';
            
            console.log(`🎯 Mostrando beneficios extras para categoría: ${benefitsCategory}`);
    ...
    function toggleExtraBenefit(benefitIndex) {
        // Determinar qué categoría de beneficios estamos manejando basándose en la categoría actual
        const activeTransportPlans = getActiveTransportPlans();
        const activeTechPlans = getActiveTechnologyPlans();
        
        let benefitsCategory = appState.currentCategory || 'tecnologia'; // Usar la categoría actual
        let activePlans = benefitsCategory === 'transporte' ? activeTransportPlans : activeTechPlans;
        
        console.log(`🎯 Toggling beneficio extra para categoría: ${benefitsCategory}`);
    ...
    function handleExplainCoverageClick(category, plan) {
        // Identificar el producto específico basado en la categoría y selección actual
        let productKey = '';
        if (category.id === 'tecnologia' && appState.selectedTechnology) {
            productKey = appState.selectedTechnology;
        } else if (category.id === 'transporte' && appState.selectedTransport) {
            productKey = appState.selectedTransport;
        }
        
        // Generar explicación detallada sobre la cobertura sin mostrar el prompt interno
        const explanation = generateCoverageExplanation(category, plan, productKey);
        
        // Crear historial del chat con la explicación directa
        const chatHistory = [
            { role: 'user', parts: [{ text: `¿Qué cubre exactamente el ${plan.name}?` }] },
    ...
    // Función para generar explicaciones detalladas de cobertura sin prompts internos
    function generateCoverageExplanation(category, plan, productKey) {
        const categoryId = category.id;
        const planId = plan.id;
        
        console.log(`🔍 Generando explicación para: categoría=${categoryId}, producto=${productKey}, plan=${planId}`);
        
        // Explicaciones específicas por categoría y plan
        const explanations = {
            transporte: {
                patineta: {
                    esencial: "¡Perfecto! 🛴 Te explico qué cubre tu **Plan Esencial para Patineta**:\n\n**🛡️ Cobertura Incluida:**\n• Hurto calificado de tu patineta\n• Daño total accidental\n• Daños a terceros hasta $10M\n• Asistencia básica en caso de emergencia\n\n**✅ Ejemplos de lo que SÍ cubre:**\n1. Si te roban la patineta mientras está asegurada con candado\n2. Si sufres un accidente y dañas el vehículo de otra persona\n\n**❌ Lo que NO cubre:**\n• Daños por mal uso o negligencia extrema\n\n¿Te gustaría saber más detalles? 😊",
                    
                    plus: "¡Excelente elección! 🛴⭐ Te explico tu **Plan Plus para Patineta**:\n\n**🛡️ Cobertura Incluida:**\n• Todo lo del Plan Esencial\n• Daño parcial por accidentes\n• Grúa especializada para patinetas\n• Talleres certificados\n• Asistencia técnica 24/7\n\n**✅ Ejemplos de lo que SÍ cubre:**\n1. Si se daña el sistema eléctrico en un accidente\n2. Si necesitas que recojan tu patineta después de una falla\n\n**❌ Lo que NO cubre:**\n• Daños por inmersión en agua\n\n¿Necesitas más información sobre algún beneficio? 🚀",
                    
                    premium: "¡La protección más completa! 🛴💎 Tu **Plan Premium para Patineta** incluye:\n\n**🛡️ Cobertura Total:**\n• Todo de los planes anteriores\n• Patineta de reemplazo mientras reparamos la tuya\n• Cobertura de accesorios hasta $500.000\n• Seguro de batería (para eléctricas)\n• Asistencia premium 24/7\n\n**✅ Ejemplos de lo que SÍ cubre:**\n1. Si tu patineta necesita reparación, te damos una de cortesía\n2. Si se daña tu casco o accesorios en un accidente\n\n**❌ Lo que NO cubre:**\n• Competencias deportivas profesionales\n\n¡Tienes la protección más completa del mercado! ⭐"
                },
                
                bicicleta: {
                    esencial: "¡Genial! 🚴‍♂️ Te explico tu **Plan Esencial para Bicicleta**:\n\n**🛡️ Cobertura Incluida:**\n• Hurto calificado\n• Daño total accidental\n• Kit de herramientas básico\n• Asistencia en carretera\n\n**✅ Ejemplos de lo que SÍ cubre:**\n1. Si te roban la bici estando bien asegurada\n2. Si tienes un accidente y la bici queda inservible\n\n**❌ Lo que NO cubre:**\n• Daños por desgaste normal de uso\n\n¿Quieres conocer más beneficios? 🚲",
                    
                    plus: "¡Excelente! 🚴‍♀️⭐ Tu **Plan Plus para Bicicleta** incluye:\n\n**🛡️ Cobertura Mejorada:**\n• Todo del Plan Esencial\n• Mecánico a domicilio mensual\n• Reparación de daños parciales\n• Asistencia técnica especializada\n\n**✅ Ejemplos de lo que SÍ cubre:**\n1. Servicio de mecánico en tu casa cada mes\n2. Reparación si se daña la transmisión\n\n**❌ Lo que NO cubre:**\n• Modificaciones no autorizadas\n\nPerfecto para ciclistas regulares! 🔧",
                    
                    premium: "¡La protección definitiva! 🚴‍♂️💎 Tu **Plan Premium para Bicicleta**:\n\n**🛡️ Cobertura Completa:**\n• Todo de los planes anteriores\n• Bicicleta de cortesía\n• Programa fitness incluido\n• Cobertura de accesorios\n• GPS antirrobo\n\n**✅ Ejemplos de lo que SÍ cubre:**\n1. Bici de reemplazo mientras reparamos la tuya\n2. Acceso a rutinas de entrenamiento personalizadas\n\n**❌ Lo que NO cubre:**\n• Daños en competencias extremas\n\n¡El plan más completo para ciclistas apasionados! 🏆"
                },
            ...
            tecnologia: {
                celular: {
                    esencial: "¡Perfecto! 📱 Te explico tu **Plan Esencial para Celular**:\n\n**🛡️ Cobertura Digital:**\n• Hurto calificado\n• Daño accidental básico\n• Gestión 100% digital\n• Soporte técnico básico\n\n**✅ Ejemplos de lo que SÍ cubre:**\n1. Si te roban el celular en la calle\n2. Si se daña la pantalla por una caída\n\n**❌ Lo que NO cubre:**\n• Daños por líquidos\n\n¡Protección esencial para tu vida digital! 📲",
                    
                    plus: "¡Excelente! 📱⭐ Tu **Plan Plus para Celular**:\n\n**🛡️ Cobertura Mejorada:**\n• Todo del Plan Esencial\n• Reparación de pantalla incluida\n• Servicio a domicilio\n• Recuperación de datos\n\n**✅ Ejemplos de lo que SÍ cubre:**\n1. Técnico va a tu casa para reparaciones\n2. Recuperamos tus fotos si se daña la memoria\n\n**❌ Lo que NO cubre:**\n• Pérdida por descuido\n\nPerfecto para usuarios intensivos! 🔧",
                    
                    premium: "¡La protección total! 📱💎 Tu **Plan Premium para Celular**:\n\n**🛡️ Cobertura Completa:**\n• Todo de los planes anteriores\n• Celular de respaldo\n• Transferencia de datos automática\n• Cobertura contra líquidos\n• Asistencia premium\n\n**✅ Ejemplos de lo que SÍ cubre:**\n1. Te damos un celular mientras reparamos el tuyo\n2. Protección total contra agua y líquidos\n\n**❌ Lo que NO cubre:**\n• Pérdida intencional\n\n¡La máxima protección para tu smartphone! 🌟"
                },
                
                portatil: {
                    esencial: "¡Genial! 💻 Te explico tu **Plan Esencial para Portátil**:\n\n**🛡️ Cobertura Básica:**\n• Hurto calificado\n• Daño total accidental\n• Soporte técnico 24/7\n• Gestión digital\n\n**✅ Ejemplos de lo que SÍ cubre:**\n1. Si te roban el portátil de tu mochila\n2. Si se daña completamente por una caída\n\n**❌ Lo que NO cubre:**\n• Virus o software malicioso\n\n¡Protección esencial para tu trabajo! 💼",
                    
                    plus: "¡Excelente elección! 💻⭐ Tu **Plan Plus para Portátil**:\n\n**🛡️ Cobertura Avanzada:**\n• Todo del Plan Esencial\n• Equipos de préstamo\n• Recuperación de datos avanzada\n• Reparación express\n\n**✅ Ejemplos de lo que SÍ cubre:**\n1. Te prestamos un portátil mientras reparamos\n2. Recuperamos archivos importantes\n\n**❌ Lo que NO cubre:**\n• Daños por modificaciones no autorizadas\n\nPerfecto para profesionales! 🚀",
                    
                    premium: "¡La protección definitiva! 💻💎 Tu **Plan Premium para Portátil**:\n\n**🛡️ Cobertura Total:**\n• Todo de los planes anteriores\n• Equipo de reemplazo premium\n• Respaldo automático en la nube\n• Soporte técnico premium\n• Protección contra ciberataques\n\n**✅ Ejemplos de lo que SÍ cubre:**\n1. Reemplazo inmediato con equipo de alta gama\n2. Protección contra ransomware y virus\n\n**❌ Lo que NO cubre:**\n• Uso para minería de criptomonedas\n\n¡La máxima protección tecnológica! ⚡"
                },
                
                gadgets: {
                    esencial: "¡Perfecto! 🎧 Te explico tu **Plan Esencial para Gadgets**:\n\n**🛡️ Cobertura Básica:**\n• Hurto calificado\n• Daño accidental\n• Múltiples dispositivos\n• Gestión digital simple\n\n**✅ Ejemplos de lo que SÍ cubre:**\n1. Si te roban los audífonos o smartwatch\n2. Si se dañan por caída accidental\n\n**❌ Lo que NO cubre:**\n• Pérdida por olvido\n\n¡Protege todos tus gadgets favoritos! 📟",
                    
                    plus: "¡Excelente! 🎧⭐ Tu **Plan Plus para Gadgets**:\n\n**🛡️ Cobertura Mejorada:**\n• Todo del Plan Esencial\n• Reemplazo temporal\n• Configuración automática\n• Soporte técnico especializado\n\n**✅ Ejemplos de lo que SÍ cubre:**\n1. Te damos gadgets de reemplazo temporal\n2. Configuramos automáticamente tus dispositivos nuevos\n\n**❌ Lo que NO cubre:**\n• Dispositivos obsoletos\n\nPerfecto para tech lovers! 🔧",
                    
                    premium: "¡La protección total! 🎧💎 Tu **Plan Premium para Gadgets**:\n\n**🛡️ Cobertura Completa:**\n• Todo de los planes anteriores\n• Actualización de tecnología\n• Seguro de accesorios\n• Servicio concierge\n• Protección global\n\n**✅ Ejemplos de lo que SÍ cubre:**\n1. Actualización a modelos más nuevos\n2. Protección mundial en viajes\n\n**❌ Lo que NO cubre:**\n• Dispositivos experimentales\n\n¡La experiencia tech más completa! 🌍"
                }
            }
        };
        
        // Buscar la explicación específica
        const categoryExplanations = explanations[categoryId];
        if (categoryExplanations && productKey) {
            const productExplanations = categoryExplanations[productKey];
            if (productExplanations) {
                const specificExplanation = productExplanations[planId];
                if (specificExplanation) {
                    console.log(`✅ Explicación específica encontrada para ${categoryId}-${productKey}-${planId}`);
                    return specificExplanation;
                }
            }
        }
        
        console.log(`⚠️ No se encontró explicación específica, usando genérica`);
        // Explicación genérica si no se encuentra específica
        return `¡Hola! 😊 Te explico la cobertura de tu **${plan.name}**:\n\n**🛡️ Cobertura:** ${plan.coverage}\n\n**💰 Precio:** ${plan.price}\n\n**✨ Beneficios principales:**\n${plan.benefits.map(benefit => `• ${benefit}`).join('\n')}\n\n¿Te gustaría conocer más detalles sobre algún beneficio específico? ¡Estoy aquí para ayudarte! 🤗`;
    }
